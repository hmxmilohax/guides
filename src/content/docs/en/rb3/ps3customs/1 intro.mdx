...
description: "How to add custom songs to Rock Band 3's PS3 version."
...
* An up to date version of <a href="https://nemosnautilus.com/nautilus" target="_blank" rel="noopener noreferrer">[Nautilus]</a><sup>a <Icon name="linux" label="Linux" /></sup> (Previously known as C3 CON Tools/C3Tools).
	* <a href="https://github.com/trojannemo/Nautilus/releases" target="_blank" rel="noopener noreferrer">[Mirror Link]</a><sup><Icon name="linux" label="Linux" /></sup>
...
* An up to date version of <a href="https://github.com/LocalH/MoggInspector/releases" target="_blank" rel="noopener noreferrer">[MoggInspector]</a><sup>a <Icon name="linux" label="Linux" /></sup>.

<Aside><Icon name="linux" label="Linux" />: This program is designed for Windows but can run on Linux via WINE or Proton. Check your Linux distro documentation for more information.</Aside>